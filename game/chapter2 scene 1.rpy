...
label chap_2_scene_18:
    ...
    Evelyn "Veronica helped me to move away safely.. I just never was the same again"
    ...
    "Judge Desiato" "Defence may present their arguments"
    ...
    Jennifer "It may be easy to present to the court only the cases that are in the nature of this suit , but there are alot of cases against my client due to his position of power"
    ...
    Mia "( Father..)"
    scene blackscreen
    show titletext "Outside district court , New york" with dissolve
    pause 1.0
    window hide
...
label chap_2_scene_19:
    scene blackscreen
    show titletext "Isolated park , Harlem" with dissolve
    pause 1.0
    window hide
    ...
    Jake "She said that you don't owe anyone anything in this world, no explanations, no tears, no laughs, or anything"
...
label chap_2_scene_20:
    scene blackscreen
    show titletext "Persiphia hotel , New york" with dissolve
    pause 1.0
    window hide
    ...
    John "Understood!"
    scene blackscreen
    show titletext "Mason's home , Brooklyn" with dissolve
    pause 1.0
    window hide
...
label chap_2_scene_21:
    scene blackscreen
    show titletext "Veronica's house , Brooklyn" with dissolve
    pause 1.0
    window hide
    ...
    Veronica "I just sent mason a text , he doesn't seem to reply but if you want i can drop you off home"
    ...
    Veronica "Alright i will , I just want you guys to be happy that's all"
...
label chap_2_scene_22:   
    ...
    scene blackscreen
    show titletext "Early morning , Osaka" with dissolve
    pause 1.0
    window hide
...
label chap_2_scene_24:
    ...
    Natsuko "So which computer exactly , is it these boxes?"
    Kiara "It's this , need to set it up but my room space is abit small"
    ...
    Kiara "The corner is very clean for even something unused , you cleaned it just now didn't you?"
    Natsuko "Um.. well."
    ...
    Natsuko "Okay tables fitting good and nice"
    ...
    label .part_2:
        ...
        Natsuko "Thanks really ,  I do appreciate it and i like genuine compliments"
...
label chap_2_scene_25:
    ...
    # SCENE - > ymacallsgmnt -> 
    scene blackscreen
    show titletext "Bit later.." with dissolve
    pause 1.0
    window hide
    ...
    scene blackscreen
    show titletext "Yamazaki's basement , Arcadia HQ" with dissolve
    pause 1.0
    window hide
    ...
    Yamazaki "No you didn't and the pc won't start? Did you follow the included guide?"
    ...
    Yamazaki "Well there used to be computers with vga sockets and cables so"
    ...
    label .part_1:
        ...
        Kiara "The camera was on i forgot , he must've thought i was bending over intentionally.. dammit"
...
label chap_2_scene_26:
    # SCENE -> levinhmdtwo -> 
    scene blackscreen
    show titletext "House entrance.." with dissolve
    pause 1.0
    window hide
    ...
    Xia "( Kiara.. , you will find happiness again. Be it with or without us I'm sure of it. )"
...
label chap_2_scene_27:
    # SCENE -> rinsxscndytwo ->
    scene blackscreen
    show titletext "Pacific hotel , Osaka" with dissolve
    pause 1.0
    window hide
    ...
    Rin "Getting him into the changing rooms are you hehe?"
    ...
    Rin "Heh sure babe , well just bring some food okay?"
    ...
    label .part_2:
        ...
        "Hotel waiter" "My apologies mam i'll get that lowered but try reaching it on table>"
        scene bg rinsxscnstrt 8 with Dissolve(0.8)
        Rin "See? it's like beyond the reach , just carry me and then we'll get it"
        ...
        "Hotel waiter" "Aah! mam i am fall-"
...
label chap_2_scene_28:
    # SCENE -> dytwocsplay->
    scene blackscreen
    show titletext "Taka's Shop" with dissolve
    pause 1.0
    window hide
...
label chap_2_scene_29:
    ...
    scene blackscreen
    show titletext "Outside taka's shop , Local district" with dissolve
    pause 1.0
    window hide
    ...
    Kiara "Alright mister , surprise me then"
    # End 0.2
    "End 0.2"
    return
